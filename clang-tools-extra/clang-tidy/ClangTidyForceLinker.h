...
// This anchor is used to force the linker to link the BitcoinModule.
extern volatile int BitcoinModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED BitcoinModuleAnchorDestination =
    BitcoinModuleAnchorSource;
